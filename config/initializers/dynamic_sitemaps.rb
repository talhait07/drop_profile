...
DynamicSitemaps.configure do |config|
  ...
  # DynamicSitemaps can automatically ping Google and Bing
  # config.search_engine_ping_urls << 'http://search.yahooapis.com/SiteExplorerService/V1/ping?sitemap=%s'
  # config.search_engine_ping_urls << 'http://submissions.ask.com/ping?sitemap=%s'
end
